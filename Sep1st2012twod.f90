...
parameter iterate=2
parameter npoints1=4 !8
parameter npoints2=4 !8
...
XbarV(1)=FloatX
XBarV(2)=3.0 !landa-0.115-0.0055
...
OPEN(25,file='solidlocation.CSV') 
...
write(165,'(A150)') "time,Gage1,Gage2,Gage3,Gage4,Gage5,Gage6,Gage7,Gage8,Gage9,Gage10,Gage11,Gage12,Gage13,Gage14"
...
write (25,'(9(1x,e15.7,A))') tp*dt,",",XBarV(1),",",XBarV(2),",",tetaplot,",",omegaz,",",Drag(1),",",Lift,",",MomentFX,",",MomentFY
...
write(165,1200) tp*dt,',',YFreeG(1),',',YFreeG(2),',',YFreeG(3),',',YFreeG(4),',',YFreeG(5),',',YFreeG(6),',' &
                & ,YFreeG(7),',',YFreeG(8),',',YFreeG(9),',',YFreeG(10),',',YFreeG(11),',',YFreeG(12),',',YFreeG(13),',',YFreeG(14)

1200  format (15(1x,e15.7,1A))
!! Post processing End  !! 
...
wwave=sqrt( -gy*kwave*tanh(kwave*hait)  )
period=2*pi/wwave
print *, period,"period"
...
UBarV(1) =0 !(sumu)/Tmass +dt/Tmass*(-197.58*(xbarV(1)-floatx)-19.8*(UBarV(1)))
UBarV(2)  = (sumv)/Tmass +dt/Tmass*(-10000*(Xbarv(2)-3.0)) 
